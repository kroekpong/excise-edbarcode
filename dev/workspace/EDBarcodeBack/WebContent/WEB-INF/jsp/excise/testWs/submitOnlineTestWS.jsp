...
<div class="fadeIn active">
	...
	<form action="/EDBarcodeBack/testws/responseSubmitOnlineWs.htm" method="post">
		...
		<table style="height: 500px;">
			...
			<tr>
				<td>
					<textarea rows="1" cols="1" style="height: 500px; width: 500px;" name="strInput"><soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:bar="http://www.excise.go.th/xsd/barcode">
   <soapenv:Header/>
   <soapenv:Body>
