package th.go.excise.edbarcode.ws.client.barcode.submitonline.service.test;
...
import th.go.excise.edbarcode.ws.client.barcode.submitonline.service.SubmitOnlineBackServiceImpl;
...
public class SubmitOnlineServiceImpl implements SubmitOnlineService {
	...
	public String doService(String xmlString) {
		...
		logger.info(" ########################### Bessfore Call submitOnlineWsTemplate");
