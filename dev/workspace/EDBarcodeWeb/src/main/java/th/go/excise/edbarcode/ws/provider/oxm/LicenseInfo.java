 ...
 *         &lt;element name="LicenseCurrentPrice" type="{http://www.w3.org/2001/XMLSchema}decimal"/>
...
public class LicenseInfo {
    ...
    @XmlElement(name = "LicenseCode", required = true, nillable = true)
    protected String licenseCode;
    @XmlElement(name = "LicenseSeq", required = true, nillable = true)
    protected String licenseSeq;
    @XmlElement(name = "LicenseName", required = true, nillable = true)
    protected String licenseName;
    @XmlElement(name = "LicenseCurrentPrice", required = true, nillable = true)
    protected BigDecimal licenseCurrentPrice;
    ...
    @XmlElement(name = "FirstDate", required = true, nillable = true)
    protected String firstDate;
    @XmlElement(name = "OfficeCode", required = true, nillable = true)
    protected String officeCode;
    @XmlElement(name = "LicBook", required = true, nillable = true)
    ...
    @XmlElement(name = "LineNo", required = true, nillable = true)
     ...
     *     
     */
    public BigDecimal getLicenseCurrentPrice() {
     ...
     *     
     */
    public void setLicenseCurrentPrice(BigDecimal value) {
