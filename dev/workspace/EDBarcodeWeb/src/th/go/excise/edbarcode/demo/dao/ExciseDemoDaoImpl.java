...
import th.go.excise.edbarcode.common.persistence.dao.AbstractCommonDao;
...
public class ExciseDemoDaoImpl extends AbstractCommonDao implements ExciseDemoDao {
	...
	public ProductDemo getProductDetail(String productCode) {
		...
		StringBuilder sql = new StringBuilder();
		sql.append(" SELECT product_group ");
