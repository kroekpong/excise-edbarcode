...
_pageData.template = {
	companyRow : '<tr class="tr-company"> <th class="center" rowspan="{size1}" style="vertical-align: top;">{rowNo}</th>'
		+'<th rowspan="{size2}" style="vertical-align: top;">{companyName}</th> </tr>' ,
	productRow : '<tr class="tr-product"> <th >{goodsName}</th>'
		+'<th class="right">{degree}</th>'
		+'<th class="right">{size}</th>'
		+'<th class="right">{price1}</th> '
		+'<th class="right">{quantityBottle}</th>'
		+'<th class="right">{quantityLite}</th> '
		+'<th class="right">{vat}</th> </tr>' ,
	summaryRow : '<tr class="tr-summary"> <th class="summary" colspan="6" ><b>รวม</b></th>'
		+'<th class="summary">{sumBottle}</th>'
		+'<th class="summary">{sumLite}</th>'
		+'<th class="summary">{sumVat}</th> </tr>',
