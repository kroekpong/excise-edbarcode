...
_pageData.template = {
	...
	headerRow : '<tr class="header">'
		...
		+	'<th colspan="4" style="width:428px">ต.ค. 2557</th>'
		+	'<th rowspan="2" style="width:88px">เดือนนี้ ปีก่อน</th>'
		+	'<th rowspan="2" style="width:90px">แตกต่าง</th>'
		+	'<th rowspan="2" style="width:84px">ร้อยละ</th>'
		+'</tr>'
		+'<tr class="header">'
		+	'<th style="width:164px">ชื่อสุรา</th>'
		+	'<th style="width:88px">ดีกรี</th>'
		+	'<th style="width:88px">ขนาดบรรจุ(ลิตร)</th>'
		+	'<th style="width:88px">ภาษี(บาท)</th>'
		+'</tr> '
};
